...
from trainer.helper import after_subplot
...
def optimize(data_loaders, model, optimizer, loss, n_epochs, model_path, project_id, bucket_name, interactive_tracking=False):
    """
